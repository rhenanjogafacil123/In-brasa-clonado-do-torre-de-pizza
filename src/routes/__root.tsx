...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Bora de Batata | Batatas recheadas e pastéis" },
      {
        name: "description",
        content:
          "Batatas recheadas de 300g e 500g, pastel montável e bebidas. Peça Bora de Batata pelo WhatsApp.",
      },
      { name: "author", content: "Bora de Batata" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "preload", href: "/bora-hero.png", as: "image", type: "image/png" },
      ...
      { rel: "icon", type: "image/svg+xml", href: "/bora-logo.svg" },
    ],
  }),
